...
@click.option("-b","--backbone", type=click.Choice(["300m","600m","6b"]), default="600m", show_default=True,
              help="Embedding backbone matching your published weights")
...
def main(gff_out, min_p, backbone, model_id, revision, device, token, tmp_dir, quiet, fastas):
    """
